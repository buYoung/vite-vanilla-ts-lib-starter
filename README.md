...
This is a template repo. Click the green [Use this template](https://github.com/kbysiec/library-name/generate) button to get started.
...
```bash
git clone https://github.com/kbysiec/library-name.git
cd library-name
npm i
```
